    ...
    <div className={`min-h-screen ${isDrJay ? 'bg-gradient-to-br from-blue-50 to-white' : 'bg-gradient-to-br from-teal-50 to-white'}`}>
      ...
      <div className={`${colorScheme.primary} py-16`}>
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <button className={`inline-flex items-center px-8 py-4 rounded-lg font-semibold transition-all duration-200 ${colorScheme.button} text-white hover:shadow-lg transform hover:-translate-y-0.5`}>
