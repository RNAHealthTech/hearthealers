...
const VideoTestimonials: FC<VideoTestimonialsProps> = memo(({ doctorName }) => {
    const videoData = useMemo(() => {
        const allVideos = {
            dranupam: [
                { id: 1, title: "Dr. Anupam Das video 1", embedUrl: "https://www.facebook.com/plugins/video.php?height=314&href=https%3A%2F%2Fwww.facebook.com%2FSarvodayafaridabad%2Fvideos%2F1503211114046030%2F&show_text=false&width=560&t=0" },
                { id: 2, title: "Dr. Anupam Das video 2", embedUrl: "https://www.facebook.com/plugins/video.php?height=314&href=https%3A%2F%2Fwww.facebook.com%2FSarvodayafaridabad%2Fvideos%2F794734270125619%2F&show_text=false&width=560&t=0" }
            ],
            drjay: [
        ...
        const selectedVideos = allVideos[doctorName as keyof typeof allVideos]
...
// const VideoTestimonials: FC<VideoTestimonialsProps> = memo(({ doctorName }) => {
//     const videoData = useMemo(() => {
//         // This object holds all the video data
//         const allVideos = {
//             anupamDas: [
//                 { id: 1, title: "Dr. Anupam Das video 1", embedUrl: "https://www.facebook.com/plugins/video.php?height=314&href=https%3A%2F%2Fwww.facebook.com%2FSarvodayafaridabad%2Fvideos%2F1503211114046030%2F&show_text=false&width=560&t=0" },
//                 { id: 2, title: "Dr. Anupam Das video 2", embedUrl: "https://www.instagram.com/reel/DOf1_vpDJoB/?utm_source=ig_embed&amp;utm_campaign=loading" },
//                 { id: 3, title: "Dr. Anupam Das video 3", embedUrl: "https://www.instagram.com/reel/DOQj6ELk0Ue/?utm_source=ig_embed&amp;utm_campaign=loading" },
//             ],
//             jayRelan: [
//                 { id: 1, title: "Patient Success Story 1", embedUrl: "https://www.facebook.com/plugins/video.php?height=314&href=https%3A%2F%2Fwww.facebook.com%2FSarvodayafaridabad%2Fvideos%2F770434262050552%2F&show_text=false&width=560&t=0" },
//                 { id: 2, title: "Patient Success Story 2", embedUrl: "https://www.facebook.com/plugins/video.php?height=314&href=https%3A%2F%2Fwww.facebook.com%2FSarvodayafaridabad%2Fvideos%2F1571367097170260%2F&show_text=false&width=560&t=0" },
...
//         // Return the correct video array based on the doctorName prop
//         return allVideos[doctorName] || [];
//     }, [doctorName]);

//     // Only render the component if there are videos to display
//     if (videoData.length === 0) {
//         return null;
//     }
...
//     // dr relan videos
//    const allVideoTestimonials = useMemo(() => {
//     return {
//         anupamDas: [
//             { id: 1, title: "Dr. Anupam Das video 1", embedUrl: "https://www.facebook.com/plugins/video.php?height=314&href=https%3A%2F%2Fwww.facebook.com%2FSarvodayafaridabad%2Fvideos%2F1503211114046030%2F&show_text=false&width=560&t=0" },
//             { id: 2, title: "Dr. Anupam Das video 2", embedUrl: "https://www.instagram.com/reel/DOf1_vpDJoB/?utm_source=ig_embed&amp;utm_campaign=loading" },
...
//                 </div>
//             </div>
//             <VideoTestimonials isJayRelan={isJayRelan} allVideoTestimonials={allVideoTestimonials} />
//         </section>
//     );
// };
