...
import { X, Phone, Calendar, MessageCircle, User, MapPin } from 'lucide-react';
...
Appointment Type: ${formData.appointmentType}${variant === 'drjay' ? `
        ...
        <div className="p-6">
          ...
          {state.succeeded ? (
            ...
            <form onSubmit={handleFinalSubmit} className="space-y-4">
              ...
              {/* Hospital Selection - Only for Dr. Jay */}
              {variant === 'drjay' && (
                <div>
                  ...
                  >
                    ...
                    <option value=" Sarvodaya Hospital, Sector-8, Faridabad">
                       Sarvodaya Hospital, Sector-8, Faridabad
                    </option>
                    <option value="Madhukar Rainbow Children's Hospital, Malviya Nagar, Delhi">
                      Madhukar Rainbow Children&apos;s Hospital, Malviya Nagar, Delhi
                    </option>
                    <option value="Sitaram Bhartia Institute of Science and Research, Qutab Institutional area, Delhi">
                      Sitaram Bhartia Institute of Science and Research, Qutab Institutional area, Delhi
                    </option>
                    <option value="Apollo Cradle Maternity & Child Hospital, Greater Kailash, Delhi">
                      Apollo Cradle Maternity & Child Hospital, Greater Kailash, Delhi
                    </option>
                  </select>
                </div>
              )}
              ...
              <button
                type="submit"
                disabled={state.submitting || !formData.appointmentType || (variant === 'drjay' && !formData.hospital)}
